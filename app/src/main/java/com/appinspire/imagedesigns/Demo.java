...
public final class Demo {
    ...
    public static String[] getPosters() {
        return new String[]{
                POSTERS_PATH + "Design1.jpg?alt=media",
                POSTERS_PATH + "Design2.jpg?alt=media",
                POSTERS_PATH + "Design3.jpg?alt=media",
                POSTERS_PATH + "Design4.jpg?alt=media",
                POSTERS_PATH + "Design5.jpg?alt=media",
                POSTERS_PATH + "Design6.jpg?alt=media",
                POSTERS_PATH + "Design7.jpg?alt=media",
                POSTERS_PATH + "Design8.jpg?alt=media",
                POSTERS_PATH + "Design9.jpg?alt=media",
                POSTERS_PATH + "Design10.jpg?alt=media",
                POSTERS_PATH + "Design11.jpg?alt=media",
                POSTERS_PATH + "Design12.jpg?alt=media",
                POSTERS_PATH + "Design13.jpg?alt=media",
                POSTERS_PATH + "Design14.jpg?alt=media",
                POSTERS_PATH + "Design15.jpg?alt=media",
                POSTERS_PATH + "Design16.jpg?alt=media",
                POSTERS_PATH + "Design17.jpg?alt=media",
                POSTERS_PATH + "Design18.jpg?alt=media",
                POSTERS_PATH + "Design19.jpg?alt=media",
                POSTERS_PATH + "Design20.jpg?alt=media",
                POSTERS_PATH + "Design21.jpg?alt=media",
                POSTERS_PATH + "Design22.jpg?alt=media",
                POSTERS_PATH + "Design23.jpg?alt=media",
                POSTERS_PATH + "Design24.jpg?alt=media",
                POSTERS_PATH + "Design25.jpg?alt=media",
                POSTERS_PATH + "Design26.jpg?alt=media",
                POSTERS_PATH + "Design27.jpg?alt=media",
                POSTERS_PATH + "Design28.jpg?alt=media",
                POSTERS_PATH + "Design29.jpg?alt=media",
                POSTERS_PATH + "Design30.jpg?alt=media",
                POSTERS_PATH + "Design31.jpg?alt=media",
                POSTERS_PATH + "Design32.jpg?alt=media",
                POSTERS_PATH + "Design33.jpg?alt=media",
                POSTERS_PATH + "Design34.jpg?alt=media",
                POSTERS_PATH + "Design35.jpg?alt=media",
                POSTERS_PATH + "Design36.jpg?alt=media",
                POSTERS_PATH + "Design37.jpg?alt=media",
                POSTERS_PATH + "Design38.jpg?alt=media",
                POSTERS_PATH + "Design39.jpg?alt=media",
                POSTERS_PATH + "Design40.jpg?alt=media",
                POSTERS_PATH + "Design41.jpg?alt=media",
                POSTERS_PATH + "Design42.jpg?alt=media",
                POSTERS_PATH + "Design43.jpg?alt=media",
                POSTERS_PATH + "Design44.jpg?alt=media",
                POSTERS_PATH + "Design45.jpg?alt=media",
                POSTERS_PATH + "Design46.jpg?alt=media",
                POSTERS_PATH + "Design47.jpg?alt=media",
                POSTERS_PATH + "Design48.jpg?alt=media",
                POSTERS_PATH + "Design49.jpg?alt=media",
                POSTERS_PATH + "Design50.jpg?alt=media",
                POSTERS_PATH + "Design51.jpg?alt=media",
                POSTERS_PATH + "Design52.jpg?alt=media",
                POSTERS_PATH + "Design53.jpg?alt=media",
                POSTERS_PATH + "Design54.jpg?alt=media",
                POSTERS_PATH + "Design55.jpg?alt=media",
                POSTERS_PATH + "Design56.jpg?alt=media",
                POSTERS_PATH + "Design57.jpg?alt=media",
                POSTERS_PATH + "Design58.jpg?alt=media",
                POSTERS_PATH + "Design59.jpg?alt=media",
                POSTERS_PATH + "Design60.jpg?alt=media",
        };
